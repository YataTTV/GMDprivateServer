...
$string["createNewPack"] = "Izveidot jaunu Map Pack!"; // Translate word "create" like "You'll need to create new map pack!", but its call to action
...
$string["createNewGauntlet"] = "Izveidot jaunu Gauntlet!"; // Translate word "create" like "You'll need to create new gauntlet!", but its call to action
